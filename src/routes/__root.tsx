...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Surya Cine Special Props — Film Prop Rental" },
      {
        name: "description",
        content: "Cinematic film prop rental: armory, camera rigs, vintage vehicles and hero gadgets.",
      },
      { name: "author", content: "Surya Cine Special Props" },
